                        ...
                        <li>
                            <a href="{{ route('data-siswa.create') }}"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Tambah siswa baru</p>
                                </div>
                            </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                                            ...
                                            <ul class="py-1 text-sm">
                                                ...
                                                <!-- Edit -->
                                                <li>
                                                    <a href="{{ route('data-siswa.edit', $siswa->nis) }}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-xs text-gray-400">Ubah data siswa</p>
                                                        </div>
                                                    </a>
                                                </li>
                                                    ...
                                                    <form action="{{ route('data-siswa.destroy', $siswa->nis) }}" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <div class="text-left">
                                                                ...
                                                                <p class="text-xs text-gray-400">Hapus data siswa</p>
                                                            </div>
                                                        </button>
                                                    </form>
                                                </li>
