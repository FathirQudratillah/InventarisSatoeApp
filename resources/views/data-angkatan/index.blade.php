            ...
            <div class="relative inline-block text-left">
                ...
                <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                    ...
                    <ul class="py-1 text-sm">
                        <li>
                            <a href="{{ route('data-angkatan.create') }}"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Tambah angkatan baru</p>
                                </div>
                            </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                                            ...
                                            <ul class="py-1 text-sm">
                                                ...
                                                <!-- Edit -->
                                                <li>
                                                    <a href="{{ route('data-angkatan.edit', $angkatan->angkatan) }}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-xs text-gray-400">Ubah data angkatan</p>
                                                        </div>
                                                    </a>
                                                </li>
                                                ...
                                                <!-- Delete -->
                                                <li>
                                                    <form action="{{ route('data-angkatan.destroy', $angkatan->angkatan) }}" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <div class="text-left">
                                                                ...
                                                                <p class="text-xs text-gray-400">Hapus data angkatan</p>
                                                            </div>
                                                        </button>
                                                    </form>
                                                </li>
