<x-layout>
    ...
    <a href="{{ route('data-akun.index') }}"
        class="fixed top-4 right-4 flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-400 rounded-lg hover:bg-gray-700 hover:text-white transition-all duration-150 z-50">
