            ...
            <div class="relative inline-block text-left">
                ...
                <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                    ...
                    <ul class="py-1 text-sm">
                        <li>
                            <a href="{{ route('data-ruang.create') }}"
                                    ...
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                                            ...
                                            <ul class="py-1 text-sm">
                                                ...
                                                <!-- Edit -->
                                                <li>
                                                    <a href="{{ route('data-ruang.edit', $ruang->id_ruang) }}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-xs text-gray-400">Ubah data ruang</p>
                                                        </div>
                                                    </a>
                                                </li>
                                                ...
                                                <!-- Delete -->
                                                <li>
                                                    <form action="{{ route('data-ruang.destroy', $ruang->id_ruang) }}" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <div class="text-left">
                                                                ...
                                                                <p class="text-xs text-gray-400">Hapus data ruang</p>
                                                            </div>
                                                        </button>
                                                    </form>
                                                </li>
