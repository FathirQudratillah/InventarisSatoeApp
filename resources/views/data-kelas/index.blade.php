                        ...
                        <li>
                            <a href="{{ route('data-kelas.create') }}"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Tambah kelas baru</p>
                                </div>
                            </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                                            ...
                                            <ul class="py-1 text-sm">
                                                ...
                                                <!-- Edit -->
                                                <li>
                                                    <a href="{{ route('data-kelas.edit', $kelas->id_kelas) }}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-xs text-gray-400">Ubah data kelas</p>
                                                        </div>
                                                    </a>
                                                </li>
                                                ...
                                                <!-- Delete -->
                                                <li>
                                                    <form action="{{ route('data-kelas.destroy', $kelas->id_kelas) }}" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <div class="text-left">
                                                                ...
                                                                <p class="text-xs text-gray-400">Hapus data kelas</p>
                                                            </div>
                                                        </button>
                                                    </form>
                                                </li>
