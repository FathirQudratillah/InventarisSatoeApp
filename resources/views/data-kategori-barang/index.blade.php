            ...
            <div class="relative inline-block text-left">
                ...
                <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                    ...
                    <ul class="py-1 text-sm">
                        <li>
                            <a href="{{ route('data-kategori-barang.create') }}"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Tambah kategori baru</p>
                                </div>
                            </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                                            ...
                                            <ul class="py-1 text-sm">
                                                ...
                                                <!-- Edit -->
                                                <li>
                                                    <a href="{{ route('data-kategori-barang.edit', $kategori_barang->id_kategori) }}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-xs text-gray-400">Ubah data kategori</p>
                                                        </div>
                                                    </a>
                                                </li>
                                                ...
                                                <!-- Delete -->
                                                <li>
                                                    <form action="{{ route('data-kategori-barang.destroy', $kategori_barang->id_kategori) }}" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <div class="text-left">
                                                                ...
                                                                <p class="text-xs text-gray-400">Hapus data kategori</p>
                                                            </div>
                                                        </button>
                                                    </form>
                                                </li>
