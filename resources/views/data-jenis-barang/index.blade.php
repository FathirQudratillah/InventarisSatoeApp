            ...
            <div class="relative inline-block text-left">
                ...
                <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                    ...
                    <ul class="py-1 text-sm">
                        <li>
                            <a href="{{ route('data-jenis-barang.create') }}"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Tambah jenis barang baru</p>
                                </div>
                            </a>
                        </li>
                    </ul>
                                    ...
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                                            ...
                                            <ul class="py-1 text-sm">
                                                ...
                                                <!-- Edit -->
                                                <li>
                                                    <a href="{{ route('data-jenis-barang.edit', $jenis_barang->jenis_barang) }}"
                                                ...
                                                <!-- Delete -->
                                                <li>
                                                    <form action="{{ route('data-jenis-barang.destroy', $jenis_barang->jenis_barang) }}" method="POST"
